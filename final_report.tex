...
We implemented a steering environment where the robot must follow target directions while maintaining motion style. The task reward combines directional objectives:
\begin{equation}
...
\end{equation}
We trained steering tasks for both AMP and ADD to evaluate their directional control capabilities under the learned motion priors.
